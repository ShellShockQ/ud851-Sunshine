...
public class MainActivity extends AppCompatActivity {
    ...
    private String mUsersPreferredLocation="";
    ...
    URL urlToExecute =   NetworkUtils.buildUrl(mUsersPreferredLocation);
    ...
    public class GetWeatherData extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... strings) {
         URL urlString=  NetworkUtils.buildUrl(strings[0].toString());
         String weatherResults="";
            try {
            weatherResults=    NetworkUtils.getResponseFromHttpUrl(urlString);
            } catch (IOException e) {
                e.printStackTrace();
            }
